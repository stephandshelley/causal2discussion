...
\begin{align*}
\Psi(P_0) = \sum_{\bar{l}}(E(Y|\bar{A}=1, \bar{L}=\bar{l}) x P(L(1)=l(1)|A(0)=1, L(0)=l(0)) x P(L(0)=l(0)) - \sum_{\bar{l}}(E(Y|\bar{A}=0, \bar{L}=\bar{l}) x P(L(1)=l(1)|A(0)=0, L(0)=l(0)) x P(L(0)=l(0))
\end{align*}
