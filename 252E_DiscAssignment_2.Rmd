...
\begin{align*}
E(Y_{\bar{a}}) = &\sum_{\bar{l}} E(Y | \bar{A}(2) = \bar{a}(2), \bar{L}(2) = \bar{l}(K) \ \ \times\\
&\prod_{0}^{2} P(L(t)=l(t) | \bar{A}(t-1) = \bar{a}(t-1), \bar{L}(t-1) = \bar{l}(t-1)) \\
\end{align*}
...
I might approach this estimation problem using nonparametric estimators, XXXXX
